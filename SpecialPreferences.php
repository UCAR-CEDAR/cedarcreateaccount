...
class PreferencesForm {
	...
	# CEDAR
	#
	var $mCedarId, $mOrg, $mAddress1, $mAddress2, $mCity, $mState;
	var $mCountry, $mPostalCode, $mPhone, $mMobilePhone, $mFax;
	var $mSupervisorName, $mSupervisorEmail;
	#
	# End CEDAR
	...
	function PreferencesForm( &$request ) {
		...
		$this->mCedarId = $wgCedar->getCedarId() ;
		$this->mOrg = $request->getVal( 'wpCedarOrg' ) ;
		$this->mAddress1 = $request->getVal( 'wpCedarAddress1' ) ;
		$this->mAddress2 = $request->getVal( 'wpCedarAddress2' ) ;
		$this->mCity = $request->getVal( 'wpCedarCity' ) ;
		$this->mState = $request->getVal( 'wpCedarState' ) ;
		$this->mCountry = $request->getVal( 'wpCedarCountry' ) ;
		$this->mPostalCode = $request->getVal( 'wpCedarPostalCode' ) ;
		$this->mPhone = $request->getVal( 'wpCedarPhone' ) ;
		$this->mMobilePhone = $request->getVal( 'wpMobilePhone' ) ;
		$this->mFax = $request->getVal( 'wpCedarFax' ) ;
		$this->mSupervisorName = $request->getVal( 'wpCedarSupervisorName' ) ;
		$this->mSupervisorEmail = $request->getVal( 'wpCedarSupervisorEmail' ) ;
		#
		# End CEDAR
	...
	function savePreferences() {
		...
		# CEDAR
		#
		$wgCedar->setOrg( $this->mOrg ) ;
		$wgCedar->setAddress1( $this->mAddress1 ) ;
		$wgCedar->setAddress2( $this->mAddress2 ) ;
		$wgCedar->setCity( $this->mCity ) ;
		$wgCedar->setState( $this->mState ) ;
		$wgCedar->setCountry( $this->mCountry ) ;
		$wgCedar->setPostalCode( $this->mPostalCode ) ;
		$wgCedar->setPhone( $this->mPhone ) ;
		$wgCedar->setMobilePhone( $this->mMobilePhone ) ;
		$wgCedar->setFax( $this->mFax ) ;
		$wgCedar->setSupervisorName( $this->mSupervisorName ) ;
		$wgCedar->setSupervisorEmail( $this->mSupervisorEmail ) ;
	...
	function resetPrefs() {
		...
		#
		global $wgCedar ;
		$this->mOrg = $wgCedar->getOrg() ;
		$this->mAddress1 = $wgCedar->getAddress1() ;
		$this->mAddress2 = $wgCedar->getAddress2() ;
		$this->mCity = $wgCedar->getCity() ;
		$this->mState = $wgCedar->getState() ;
		$this->mCountry = $wgCedar->getCountry() ;
		$this->mPostalCode = $wgCedar->getPostalCode() ;
		$this->mPhone = $wgCedar->getPhone() ;
		$this->mMobilePhone = $wgCedar->getMobilePhone() ;
		$this->mFax = $wgCedar->getFax() ;
		$this->mSupervisorName = $wgCedar->getSupervisorName() ;
		$this->mSupervisorEmail = $wgCedar->getSupervisorEmail() ;
		#
		# End CEDAR
...
<option value=\"2\"$s2>$msgUnderlinedefault</option>
		...
		if( $this->mCedarId != 0 )
		{
		$wgOut->addHTML('<fieldset><legend>Cedar</legend><table>');
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Organization</label>',
			"<input type='text' name='wpCedarOrg' id='wpCedarOrg' value=\"{$this->mOrg}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Address 1</label>',
			"<input type='text' name='wpCedarAddress1' id='wpCedarAddress1' value=\"{$this->mAddress1}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Address 2</label>',
			"<input type='text' name='wpCedarAddress2' id='wpCedarAddress2' value=\"{$this->mAddress2}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">City</label>',
			"<input type='text' name='wpCedarCity' id='wpCedarCity' value=\"{$this->mCity}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">State</label>',
			"<input type='text' name='wpCedarState' id='wpCedarState' value=\"{$this->mState}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Country</label>',
			"<input type='text' name='wpCedarCountry' id='wpCedarCountry' value=\"{$this->mCountry}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Postal Code</label>',
			"<input type='text' name='wpCedarPostalCode' id='wpCedarPostalCode' value=\"{$this->mPostalCode}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Phone</label>',
			"<input type='text' name='wpCedarPhone' id='wpCedarPhone' value=\"{$this->mPhone}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Mobile Phone</label>',
			"<input type='text' name='wpCedarMobilePhone' id='wpCedarMobilePhone' value=\"{$this->mMobilePhone}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Fax</label>',
			"<input type='text' name='wpCedarFax' id='wpCedarFax' value=\"{$this->mFax}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Supervisor Name</label>',
			"<input type='text' name='wpCedarSupervisorName' id='wpCedarSupervisorName' value=\"{$this->mSupervisorName}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
			'<label for="wpRealName">Supervisor Email</label>',
			"<input type='text' name='wpCedarSupervisorEmail' id='wpCedarSupervisorEmail' value=\"{$this->mSupervisorEmail}\" size='25' />"
		    )
		);
		$wgOut->addHTML(
		    $this->addRow(
